...
public class UserServiceImpl implements UserService {
    ...
    public User saveUser(UserRegistrationDto registrationDto) {
        ...
        String rawRole = registrationDto.getRole() != null ? registrationDto.getRole() : "ROLE_STUDENT";
        final String roleName = rawRole.startsWith("ROLE_") ? rawRole : "ROLE_" + rawRole;
        ...
        if ("ROLE_STUDENT".equals(roleName)) {
            ...
            String namePart = baseUsername;
            String firstName = Character.toUpperCase(namePart.charAt(0)) + (namePart.length() > 1 ? namePart.substring(1) : "");
