...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // 2. Default Admin User (Only Administrator exists by default)
        ...
        // 4. Courses (No predefined instructors; instructors must apply and be approved by Administrator)
        Course cs101 = courseRepository.save(new Course("CS101", "Introduction to Programming & Java", "Core Java, OOP principles, and basic algorithm design.", 4, csDept, null));
        Course cs202 = courseRepository.save(new Course("CS202", "Data Structures & Algorithms", "Linear and non-linear data structures, searching, sorting, and complexity analysis.", 4, csDept, null));
        Course ee101 = courseRepository.save(new Course("EE101", "Circuit Theory & Analysis", "DC/AC circuit fundamentals, Kirchhoff's laws, and network theorems.", 3, eeDept, null));
